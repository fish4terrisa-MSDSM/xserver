...
Bool InitKeyClassDeviceStruct(dev, pKeySyms, pModifiers) DeviceIntPtr
...
This routine is not called by InitPointerDeviceStruct for the core X
...
If the physical device is not already open, it can be done in this
